                                        ...
                                        <div class="col-xl-6 col-sm-6 col-12">
                                            <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                                <div class="product-img">
                                                    <a href="single_property.php?id=<?= encrypt($property['property_id']) ?>">
                                                        <img class="PropertyImg" src="<?= file_url . $property['property_image'] ?>" alt="#">
                                                    </a>
                                                ...
                                                <div class="product-info">
                                                    <div class="product-badge">
                                                        <ul>
                                                            <li class="sale-badg">For Construction</li>
                                                        </ul>
                                                    </div>
                                                    <h2 class="product-title"><a href="single_property.php?id=<?= encrypt($property['property_id']) ?>"><?= $property['property_name'] ?></a></h2>
                                                    <div class="product-img-location">
                                                        <ul>
                                                            <li>
                                                                <a href="#"><i class="flaticon-pin"></i> <?= $property['property_location'] ?></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                                                        ...
                                                        <li><span><?= $property['property_bathrooms'] ?> </span>
                                                            Bath
                                                        </li>
                                                        <li><span>3450 </span>
                                                            Square Ft
                                                    ...
                                                    <div class="product-hover-action">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="single_property.php?id=<?= encrypt($property['property_id']) ?>" title="Product Details">
                                                ...
                                                <div class="product-info-bottom">
                                                    <div class="product-price">
                                                        <span>Ksh. 2000000<label>/Month</label></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5">
                                                <div class="product-img">
                                                    <a href="single_property.php?id=<?= encrypt($property['property_id']) ?>">
                                                        <img class="PropertyImg2" src="<?= file_url . $property['property_image'] ?>" alt="#">
                                                    </a>
                                                </div>
                                                <div class="product-info">
                                                    <div class="product-badge-price">
                                                        ...
                                                        <div class="product-price">
                                                            <span>$3,400,900<label>/Month</label></span>
                                                        </div>
                                                    </div>
                                                    <h2 class="product-title"><a href="single_property.php?id=<?= encrypt($property['property_id']) ?>"><?= $property['property_name'] ?></a></h2>
                                                    <div class="product-img-location">
                                                        <ul>
                                                            <li>
                                                                <a href="locations.html"><i class="flaticon-pin"></i> <?= $property['property_location'] ?> </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                    ...
                    <div class="widget ltn__top-rated-product-widget d-none">
                        ...
                        <ul>
                            <li>
                                <div class="top-rated-product-item clearfix">
                                    <div class="top-rated-product-img">
                                        <a href="single_property.php?id=<?= encrypt($property['property_id']) ?>"><img src="img/product/1.png" alt="#"></a>
                                    </div>
                                    <div class="top-rated-product-info">
                                        ...
                                        <h6><a href="single_property.php?id=<?= encrypt($property['property_id']) ?>">Mixel Solid Seat Cover</a></h6>
                                        <div class="product-price">
                                            <span>$49.00</span>
                                            <del>$65.00</del>
                                        </div>
                            ...
                            <li>
                                <div class="top-rated-product-item clearfix">
                                    <div class="top-rated-product-img">
                                        <a href="single_property.php?id=<?= encrypt($property['property_id']) ?>"><img src="img/product/2.png" alt="#"></a>
                                    </div>
                                    <div class="top-rated-product-info">
                                        <div class="product-ratting">
                                            <ul>
                                        ...
                                        <h6><a href="single_property.php?id=<?= encrypt($property['property_id']) ?>">3 Rooms Manhattan</a></h6>
                                        <div class="product-price">
                                            <span>$49.00</span>
                                            <del>$65.00</del>
                                        </div>
                            ...
                            <li>
                                <div class="top-rated-product-item clearfix">
                                    <div class="top-rated-product-img">
                                        <a href="single_property.php?id=<?= encrypt($property['property_id']) ?>"><img src="img/product/3.png" alt="#"></a>
                                    </div>
                                    <div class="top-rated-product-info">
                                        <div class="product-ratting">
                                            <ul>
                                        ...
                                        <h6><a href="single_property.php?id=<?= encrypt($property['property_id']) ?>">Coil Spring Conversion</a></h6>
                                        <div class="product-price">
                                            <span>$49.00</span>
                                            <del>$65.00</del>
                                        </div>
