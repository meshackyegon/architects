...
$profile = get_by_id('architect', $_SESSION['architect_id']);
// cout($_SESSION);
?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <!-- Account -->
                <form method="POST" action="<?= model_url ?>architect_edit" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?= empty($profile) || empty($profile['architect_image']) ? file_url . 'user.png' : file_url . $profile['architect_image'] ?>" alt="architect_image" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    <span class="d-none d-sm-block">Upload new photo</span>
                                    <i class="bx bx-upload d-block d-sm-none"></i>
                                    <input type="file" id="upload" class="account-file-input" name="architect_image" hidden accept="image/png, image/jpeg" onchange="previewImage(this);" />
                                </label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="architect_name" name="architect_name"
                                    value="<?= $profile['architect_name'] ?>" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="email" class="form-label">E-mail</label>
                                <input class="form-control" type="text" id="architect_email" name="architect_email"
                                    value="<?= $profile['architect_email'] ?>" />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="phoneNumber" name="architect_phone" class="form-control"
                                        value="<?= $profile['architect_phone'] ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="architect_passport" name="architect_passport"
                                    value="<?= $profile['architect_passport'] ?>" />

                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="dob" class="form-label">Date of birth</label>
                                <input class="form-control" type="date" id="architect_dob" name="architect_dob"
                                    value="<?= $profile['architect_dob'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                                <label for="kra" class="form-label">KRA</label>
                                <input class="form-control" type="text" id="architect_kra" name="architect_kra"
                                    value="<?= $profile['architect_kra'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                            ...
                            <input type="hidden" name="architect_id" value="<?= $profile['architect_id'] ?>">
