            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="account-create text-center">
                        <form enctype="multipart/form-data" action="<?= model_url ?>landlord_register" method="POST">
                                ...
                                <div class="card-body card-secondary">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <?php
                                            input_hybrid("Your Name**", "landlord_name", $landlord, false);
                                            input_hybrid("Your Phone Number (use 07...)**", "landlord_phone", $landlord, true);
                                            ?>

                                            <div class="form-group">
                                                <input class="form-control" type="email" name="landlord_email" id="landlord_email" required placeholder="Enter Your Email" onBlur="checkAvailabilityEmailid()">
                                                <span id="emailid-availability" style="font-size:12px;"></span>
                                            </div>
                                            <input hidden name="landlord_status" value="inactive" />

                                            <?php
                                            input_hybrid("Your ID Number**", "landlord_passport", $landlord, false);
                                            input_hybrid("Your Password**", "landlord_password", $landlord, true);
                                            input_hybrid("Your KRA Pin**", "landlord_kra", $landlord, false);
                                            input_hybrid("Your Commission in Percentage**", "landlord_commission", $landlord, true);
                                            ?>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <?php
                                            input_hybrid("Next of Kin's Name**", "kin_name", $landlord, false);
                                            ?>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <?php
                                            input_hybrid("Next of Kin's Phone Number**", "kin_phone", $landlord, false);
                                            ?>
                                        </div>
