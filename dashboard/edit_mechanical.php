...
<div class="container-fluid">
    ...
    <form enctype="multipart/form-data" action="<?= model_url ?>edit_mechanical" method="POST">
            ...
            <div class="card-body card-secondary">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        input_hybrid("Mechanical's Phone Number", "mechanical_phone", $mechanical, true);
                        input_hybrid("Mechanical's Email", "mechanical_email", $mechanical, true, 'email');
                        input_hybrid("Mechanical's ID Number", "mechanical_passport", $mechanical, true);
