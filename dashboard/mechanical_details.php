...
$mechanical = get_by_id('mechanical', $id);
// cout($mechanical);
if (!empty($mechanical['mechanical_image'])) :
    $require = false;
    $image = $mechanical['mechanical_image'];
else :
    $require = true;
    $image = 'default.png';
endif;

$houses = explode(',', $mechanical['property_id']);

$properties = get_all('property');

$string = $mechanical['property_id'];
?>
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Mechanical Profile /</span> Profile</h4>
            ...
            <div class="card mb-4">
                ...
                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                    <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                        <img src="<?= file_url . $image ?>" alt="mechanical image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img" />
                    </div>
                    <div class="flex-grow-1 mt-3 mt-sm-5">
                        <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
                            <div class="user-profile-info">
                                <h4><?= $mechanical['mechanical_name'] ?></h4>
                                <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                    <li class="list-inline-item fw-semibold"><i class="bx bx-pen"></i> Mechanical</li>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <span><?= $mechanical['mechanical_name'] ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-check"></i><span class="fw-semibold mx-2">Status:</span> <span>Active</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-star"></i><span class="fw-semibold mx-2">Role:</span> <span>mechanical</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <span><?= $mechanical['mechanical_phone'] ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-chat"></i><span class="fw-semibold mx-2">KRA:</span> <span><?= $mechanical['mechanical_kra'] ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-envelope"></i><span class="fw-semibold mx-2">Email:</span>
                            <span style="width: 200px;"><?= $mechanical['mechanical_email'] ?></span>
                        </li>
                    </ul>
                    <a class="btn btn-outline-primary MyNewNew" href="edit_mechanical?id=<?= $_GET['id'] ?>">Edit mechanical's Details</a>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    if (!empty($properties)) { ?>
                        <form role="form" enctype="multipart/form-data" method="post" action="<?= model_url ?>houses">
                            ...
                            <input hidden name="mechanical_id" value="<?= $id ?>" />
