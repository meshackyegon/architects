...
$landlord = get_by_id('architect', security('id', 'GET'));

if (!empty($architect)) {
    session_assignment(array(
        'edit' => $architect['prod_id']
    ), false);
    $require = false;
} else {
    $require = true;
...
<div class="container-fluid">
    ...
    <form enctype="multipart/form-data" action="<?= model_url ?>architect" method="POST">
            ...
            <div class="card-body card-secondary">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        input_hybrid("Architect's Phone Number (use 07...)", "architect_phone", $architect, true);
                        input_hybrid("Architect's Email", "architect_email", $architect, true, 'email');
                        input_hybrid("Architect's ID Number", "architect_passport", $architect, false);
                        input_hybrid("Architect's Password", "architect_password", $architect, true);
