...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <?php if ($profile['landlord_status'] == 'active') { ?>
        <div class="row">
                        ...
                        <a href="view_users">
                            <div class="d-flex" style="align-items: center; justify-content:center;">
                                ...
                                <div style="width: auto; margin-left:5px;">
                                    ...
                                    <small class="text-success text-nowrap fw-semibold"><?= '0' ?></small>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="card">
                    <div class="row row-bordered g-0">
                        <div class="col-md-8">
                            ...
                            <?php if ($profile['landlord_id'] == 'LAN20230228JNo0abc') { ?>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="report-list">
                                        <div class="report-list-item rounded-2 mb-3">
                                            <div class="d-flex align-items-start">
                                                <div class="report-list-icon shadow-sm me-2">
                                                    <img src="<?= file_url . 'kra.png' ?>" width="22" alt="KRA" />
                                                </div>
                                        ...
                                        <div class="report-list-item rounded-2 mb-3">
                                            <div class="d-flex align-items-start">
                                                <div class="report-list-icon shadow-sm me-2">
                                                    <img src="<?= file_url . 'rentpesa.png' ?>" width="22" height="22" alt="Rentpesa" />
                                                </div>
                                                <div class="d-flex justify-content-between align-items-end w-100 flex-wrap gap-2">
                                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="report-list-item rounded-2">
                                            <div class="d-flex align-items-start">
                                                <div class="report-list-icon shadow-sm me-2">
                                                    <img src="<?= file_url . $profile['landlord_image'] ?>" width="22" height="22" alt="Landlord" />
                                                </div>
                                                <div class="d-flex justify-content-between align-items-end w-100 flex-wrap gap-2">
                                                    <div class="d-flex flex-column">
                                                        <span>Landlord</span>
...
<!-- Page JS -->
<style>
    .MyChartBox { /* height: 200px !important; */ }
    .MyBarChart .MyChart { height: 300px !important; }
    .OverviewCircle {
        width: 60px;
        height: 60px;
        border-radius: 50%;
