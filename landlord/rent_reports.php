...
$tenants = get_landlord_tenants($profile['landlord_id']);
...
if (isset($_GET['q'])) {
    ...
    $sql .= " WHERE payment.payment_paid = 'paid' AND property.added_by = '$profile[landlord_id]' " . $properties . $users . $units . $from . $to;
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">View</span> <?= $page ?></h4>
