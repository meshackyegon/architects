...
if (!isset($_SESSION) || $_SESSION['landlord_login'] == false) {
    $warning['login'] = 300;
    render_warning(landlord_url . 'login');
}
...
$profile = get_by_id('landlord', $_SESSION['landlord_id']);

if (!empty($profile['landlord_image'])) :
    $require = false;
    $image = $profile['landlord_image'];
else :
    $require = true;
    $image = 'land.jpg';
endif;
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="pages-account-settings-account.html">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block"><?= $profile['landlord_name'] ?></span>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="edit_landlord">
