...
$profile = get_by_id('electrical', $_SESSION['electrical_id']);
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <!-- Account -->
                <form method="POST" action="<?= model_url ?>electrical_edit" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?= empty($profile) || empty($profile['electrical_image']) ? file_url . 'user.png' : file_url . $profile['electrical_image'] ?>" alt="user_image" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    <span class="d-none d-sm-block">Upload new photo</span>
                                    <i class="bx bx-upload d-block d-sm-none"></i>
                                    <input type="file" id="upload" class="account-file-input" name="electrical_image" hidden accept="image/png, image/jpg, image/jpeg" onchange="previewImage(this);" />
                                </label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="electrical_name" name="electrical_name"
                                    value="<?= $profile['electrical_name'] ?>" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="email" class="form-label">E-mail</label>
                                <input class="form-control" type="text" id="electrical_email" name="electrical_email"
                                    value="<?= $profile['electrical_email'] ?>" />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="phoneNumber" name="electrical_phone" class="form-control"
                                        value="<?= $profile['electrical_phone'] ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="electrical_passport" name="electrical_passport"
                                    value="<?= $profile['electrical_passport'] ?>" />

                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="dob" class="form-label">Date of birth</label>
                                <input class="form-control" type="date" id="electrical_dob" name="electrical_dob"
                                    value="<?= $profile['electrical_dob'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                                <label for="kra" class="form-label">KRA</label>
                                <input class="form-control" type="text" id="electrical_kra" name="electrical_kra"
                                    value="<?= $profile['electrical_kra'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                            ...
                            <input type="hidden" name="electrical_id" value="<?= $profile['electrical_id'] ?>">
