...
$sql = "SELECT * FROM project_assignment pa join project p on pa.project_id=p.project_id join electrical el on pa.senior_electrical_id=el.electrical_id WHERE pa.senior_electrical_id='$_SESSION[electrical_id]' OR pa.senior_electrical_id='$_SESSION[electrical_id]' ";
...
for ($i = 0; $i < $num_columns; $i++) {
    $column_defs = array(
        ...
        array('data' => 'architect_name', 'title' => 'SR Electrical'),
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=  $project['electrical_name'] ?>(<?=  $project['electrical_email'] ?>)</td>
                            <!-- <td><?=  $project['completion_status'] ?></td> -->
                            <td><?=  $project['approval_status'] ?></td>
                            <!-- <td><?=  $project['status'] ?></td> -->
                            <td>
                                <?php if($_SESSION['electrical_role']==='senior'){?>
