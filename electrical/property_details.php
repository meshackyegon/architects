                ...
                <div class="card-body">
                    ...
                    <div class="info-container">
                        ...
                        <div class="d-flex justify-content-center pt-3">
                            <a href="edit_property?pid=<?= $_GET['id'] ?>&id=<?= encrypt($property['property_id']) ?>" class="btn btn-primary me-3">Edit</a>
                            ...
                            <div class="unit" data-index="<?= $index; ?>">
                                <div class="row">
                                    <div class="col-4 m-1">
                                        ...
                                        <input type="text" name="property_unit[<?= $index; ?>][property_unit_name]" id="name<?= $index; ?>" value="<?= $valueClass['property_unit_name']; ?>" required>
                                    </div>

                                    <div class="col-4 m-1">
                                        <label for="type<?= $index; ?>">Unit Type: <?= $valueClass['property_unit_type']; ?> </label>
                                        <select name="property_unit[<?= $index; ?>][property_unit_type]" id="type<?= $index; ?>">
                                    ...
                                    <div class="col-4 m-1">
                                        ...
                                        <input type="number" name="property_unit[<?= $index; ?>][property_unit_price]" id="price<?= $index; ?>" value="<?= $valueClass['property_unit_price']; ?>" required>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#add_property_unit').click(function() {
            ...
            html += '<input type="text" name="property_unit[' + index + '][property_unit_name]" id="name' + index + '" required>';
            html += '</div>';
            html += '<div class="col-4 m-1">';
            html += '<label for="type' + index + '">Unit Type:</label>';
            html += '<select name="property_unit[' + index + '][property_unit_type]" id="type' + index + '">';
            ...
            html += '<input type="number" name="property_unit[' + index + '][property_unit_price]" id="price' + index + '" required>';
            html += '</div>';
            html += '</div>';
