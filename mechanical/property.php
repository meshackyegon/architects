    ...
    <form enctype="multipart/form-data" action="<?= model_url ?>property" method="POST">
        <div class="card shadow mb-4">
            <div class="card-body card-secondary">
                ...
                <p><b>Price Details:</b> Additional information about the main price eg: 50m/200k, One month deposit needed, 6 months rent paid up-front, per annum etc. </p>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
                        ...
                        input_hybrid("Property Price", "property_price", $property, true, 'number');
                        ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
                        <?php
                        input_hybrid("Total number of units", "property_units", $property, false, 'number');
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        // input_hybrid("Number of Rooms", "property_rooms", $property, false, 'number');
