...
$sql = "SELECT * FROM project_assignment pa join project p on pa.project_id=p.project_id join mechanical mc on pa.senior_mechanical_id=mc.mechanical_id WHERE pa.senior_mechanical_id='$_SESSION[mechanical_id]' OR pa.senior_mechanical_id='$_SESSION[mechanical_id]' ";
...
for ($i = 0; $i < $num_columns; $i++) {
    $column_defs = array(
        ...
        array('data' => 'architect_name', 'title' => 'JR Mechanical'),
