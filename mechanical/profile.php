...
$profile = get_by_id('mechanical', $_SESSION['mechanical_id']);
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <!-- Account -->
                <form method="POST" action="<?= model_url ?>mechanical_edit" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?= empty($profile) || empty($profile['mechanical_image']) ? file_url . 'user.png' : file_url . $profile['mechanical_image'] ?>" alt="user_image" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    <span class="d-none d-sm-block">Upload new photo</span>
                                    <i class="bx bx-upload d-block d-sm-none"></i>
                                    <input type="file" id="upload" class="account-file-input" name="mechanical_image" hidden accept="image/png, image/jpeg" onchange="previewImage(this);" />
                                </label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="mechanical_name" name="mechanical_name"
                                    value="<?= $profile['mechanical_name'] ?>" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="email" class="form-label">E-mail</label>
                                <input class="form-control" type="text" id="mechanical_email" name="mechanical_email"
                                    value="<?= $profile['mechanical_email'] ?>" />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="phoneNumber" name="mechanical_phone" class="form-control"
                                        value="<?= $profile['mechanical_phone'] ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="mechanical_passport" name="mechanical_passport"
                                    value="<?= $profile['mechanical_passport'] ?>" />

                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="dob" class="form-label">Date of birth</label>
                                <input class="form-control" type="date" id="mechanical_dob" name="mechanical_dob"
                                    value="<?= $profile['mechanical_dob'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                                <label for="kra" class="form-label">KRA</label>
                                <input class="form-control" type="text" id="mechanical_kra" name="mechanical_kra"
                                    value="<?= $profile['mechanical_kra'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                            ...
                            <input type="hidden" name="mechanical_id" value="<?= $profile['mechanical_id'] ?>">
