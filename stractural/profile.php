    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <!-- Account -->
                <form method="POST" action="<?= model_url ?>structural_edit" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?= empty($profile) || empty($profile['structural_image']) ? file_url . 'user.png' : file_url . $profile['structural_image'] ?>" alt="structural_image" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    <span class="d-none d-sm-block">Upload new photo</span>
                                    <i class="bx bx-upload d-block d-sm-none"></i>
                                    <input type="file" id="upload" class="account-file-input" name="structural_image" hidden accept="image/png, image/jpeg" onchange="previewImage(this);" />
                                </label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="structural_name" name="structural_name"
                                    value="<?= $profile['structural_name'] ?>" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="email" class="form-label">E-mail</label>
                                <input class="form-control" type="text" id="structural_email" name="structural_email"
                                    value="<?= $profile['structural_email'] ?>" />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="phoneNumber" name="structural_phone" class="form-control"
                                        value="<?= $profile['structural_phone'] ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="structural_passport" name="structural_passport"
                                    value="<?= $profile['structural_passport'] ?>" />

                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="dob" class="form-label">Date of birth</label>
                                <input class="form-control" type="date" id="structural_dob" name="structural_dob"
                                    value="<?= $profile['structural_dob'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                                <label for="kra" class="form-label">KRA</label>
                                <input class="form-control" type="text" id="structural_kra" name="structural_kra"
                                    value="<?= $profile['structural_kra'] ?>" />
                            </div>
                              <div class="mb-3 col-md-6">
                            ...
                            <input type="hidden" name="structural_id" value="<?= $profile['structural_id'] ?>">
