...
if (isset($_SESSION) && $_SESSION['user_login'] == true) redirect_header(tenant_url . 'index');
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?= model_url ?>user_login&from=tenant/" method="POST">
                            <div class="mb-3">
